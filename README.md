...
- _[categorical logic]_ (hyper)doctrines; quantifier completions of doctrines; Grothendieck fibrations; simple (co)product completions of Grothendieck fibrations; categorical semantics for (fragments of many-sorted) first-order logic; dialectica interpretation; dialectica construction à la de Paiva;
- _[homotopy type theory]_ dependent type theories; propositional type theories; categories with attributes; comprehension categories; categorical semantics for dependent type theories.
